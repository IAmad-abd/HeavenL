                ...
                <div className="tw-flex tw-flex-1 tw-flex-col-reverse md:tw-flex-row tw-mx-auto tw-gap-8 tw-justify-between">
                  <div className="tw-flex tw-flex-col tw-gap-4 tw-flex-grow md:tw-max-w-[40%]">
                      ...
                      <div className="tw-flex tw-items-center tw-gap-2">
                        ...
                        >
                          <a
                            target="_blank"
                            rel="noopener noreferrer"
                                                                    href="hhttps://discord.com/invite/heavenland"
                          >
                            <img
                        ...
                        >
                          <a
                            target="_blank"
                            rel="noopener noreferrer"
                                                                    href="https://twitter.com/heavenland_io"
                          >
                            <img
                    ...
                    <p className="tw-mb-4 tw-text-gray-light">
                                                        Heaven Land builds a virtual reality platform where
                                                        users can experience, improve and monetize their
                                                        assets. Loyalty NFTs serve as multifunctional
                                                        assets for the Heaven Land Metaverse. Among
                                                        others, the purpose of the Loyalty NFTs is to
                                                        distribute HTO tokens to the minters. However,
                                                        the NFTs bring their owners advantages every
                                                        time they make an HTO payment through Heaven
                                                        Land services - marketplace, parcel merging,
                                                        avatar breeding, in-game payments, with much
                                                        more to come.

                                                        HTO tokens serve as the main currency in the
                                                        Heaven Land Metaverse. Everything payable in
                                                        Heaven Land will have to be paid in HTO. Heaven
                                                        Land success equals to HTO success.
                    </p>
                    ...
                    <div className="tw-w-full">
                      <div className="tw-flex tw-flex-col tw-gap-1 tw-flex-grow 3xl:tw-hidden">
                        <div className="tw-flex tw-items-center tw-justify-between tw-text-[14px] tw-text-gray-5">
                          ...
                          <span>
                            <b className="tw-text-white-1">94%</b> (7050/7500)
                          </span>
                        </div>
                          ...
                          <div className="tw-flex tw-justify-between tw-gap-6 3xl:tw-w-full">
                            ...
                            <div className="tw-flex tw-flex-col tw-gap-1 tw-flex-grow tw-hidden 3xl:tw-flex tw-flex-col-reverse tw-self-center">
                              <div className="tw-flex tw-items-center tw-justify-between tw-text-[14px] tw-text-gray-5">
                                <span className="">Total minted</span>
                                <span>
                                  <b className="tw-text-white-1">94%</b>
                                  (7050/7500)
                                </span>
                              </div>
                              <div className="progress-bar__container">
                  ...
                  <div className="tw-flex tw-flex-1 tw-flex-col md:tw-flex-row tw-mx-auto tw-gap-32 tw-pb-20 tw-justify-between">
                    <div className="tw-flex tw-flex-col tw-gap-4 tw-flex-grow md:tw-w-[40%]">
                      ...
                      <div className="tw-flex tw-flex-wrap tw-gap-4">
                        ...
                        <a
                                                                href="https://discord.com/invite/heavenland"
                          target="_blank"
                          rel="noreferrer noopener"
                          className="tw-border tw-border-solid tw-border-purple-1 tw-flex tw-items-center tw-gap-2 tw-w-fit tw-rounded-full tw-px-2.5 tw-py-1.5 tw-text-white-2"
                        >
                      ...
                      <div>
                        ...
                        <p className="tw-text-gray-light tw-mb-3 tw-text-[16] tx-line-[24]">
                                                                Loyalty NFTs Utilities

                                                                Loyalty NFTs have many utilities that will serve
                                                                its owner. Some of these utilities are one-time
                                                                (function as a Bonus) and will come into play
                                                                right after the mint; some of these utilities will
                                                                be kept forever and provide perks to their
                                                                holders. You can check the details on the
                                                                Heaven Land website here:
                                                                https://heavenland.io/loyalty

                                                                One time bonuses

                                                              - HTO token distribution
                                                              - HTO multiplier (up to 500%)
                                                              - Early access to Heaven Land
                                                              - WL for Avatars mint
                                                              - Partners NFTs airdrop

                                                                Forever utilities

                                                              - Discount for the Heaven Land marketplace
                                                              - Discount for parcels merging
                                                              - Discount for Avatars breeding
                                                              - More utilities will come as soon as the Heaven Land platform is launched

                                                                a) discount in ad-space

                                                                b) discount for in-game services

                                                                c) multiplier for in-game rewards
                          ...
                          <div className="tw-my-1">
                            ...
                            <br />
                                                                ...
                                                                <div className="tw-my-1">
                                                                    <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                      - HL economypaper
                                                                      - Parcels early adopters mint (5,000 pcs) powered by fair
                                                                        launch
                                                                      - Parcels listing on Marketplaces
                                                                    </p>
                                                                    <br />
                                                                </div>
                                                                ...
                                                                <div className="tw-my-1">
                                                                    <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                      - Heaven Land world explorer with connection to all
                                                                        marketplaces
                                                                      - Heaven Land tokenomics
                                                                      - HTO token deploy on Solana network
                                                                      - Developers diary kick off
                                                                      - 1st seed investment round ($50k+)
                                                                      - Announcements of new partners and their projects from 1.
                                                                        seed investment
                                                                      - Parcels merging system
                                                                    </p>
                                                                    <br />
                                                                </div>
                                                                ...
                                                                <div className="tw-my-1">
                                                                    <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                      - 2nd seed investment round ($10k+)
                                                                      - Announcements of new partners and their projects from 2.
                                                                        seed investment
                                                                      - Own IPFS nodes infrastructure for storing HL NFTs
                                                                      - HTO token distribution to stakeholders through audited
                                                                        vesting Solana program
                                                                    </p>
                                                                    <br />
                                                                </div>
                                                                ...
                                                                <div className="tw-my-1">
                                                                    <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                      - HTO public sale preparation and the launch
                                                                        announcement
                                                                      - HTO token video
                                                                      - Loyalty NFTs introduction
                                                                      - IDO video release
                                                                      - Concept art release
                                                                      - Developers diary releases (staking, marketplace updates,
                                                                        Loyalty NFT)
                                                                      - Heaven Land Marketplace
                                                                      - DEMO release
                                                                      - Builder video 10 Virtual World video release
                                                                    </p>
                                                                    <br />
                                                                </div>
                                                                ...
                                                                <div className="tw-my-1">
                                                                    <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                      - HTO public sale (IDO $100+)
                                                                      - Parcel staking system
                                                                      - NFT FBX Builder (buildings, avatar accessories, interior
                                                                        accessories and much more)
                                                                      - Trading NFTs from builder on HL marketplace for HTO
                                                                      - Trading all parcels on Heaven Land marketplace with HTO
                                                                      - HTO airdrop
                                                                      - Regular (weekly) parcels auctions with SOL (total 25,000
                                                                        pcs – in long term)
                                                                      - HTO DEX listing and initial liquidity supplying
                                                                      - Avatars system whitepaper
                                                                      - Avatars official mint (1,000 pcs – 500 male and 500 female
                                                                        for future breeding)
                                                                      - Trading avatars and their offsprings on HL marketplace for
                                                                        HTO
                                                                      - Parcels dividing system
                                                                    </p>
                                                                    <br />
                                                                </div>
                                                                ...
                                                                <div className="tw-my-1">
                                                                    <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                      - New high performance server cluster for HL game
                                                                      - First revenue distribution from HL marketplace to all
                                                                        residents with active stakes
                                                                    </p>
                                                                    <br />
                                                                </div>
                                                                ...
                                                                <div className="tw-my-1">
                                                                    <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                      - First version of HL game (WebGL, basic HL world in
                                                                        gravitational tubus, players interactions)
                                                                      - Solana conference
                                                                    </p>
                                                                    <br />
                                                                </div>
                                                                ...
                                                                <div className="tw-my-1">
                                                                    <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        - Solamids integration to HL game
                                                                    </p>
                                                                    <br />
                                                                </div>
                                                                ...
                                                                <div className="tw-my-1">
                                                                    <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        - Ad space system based on building surface renting as
                                                                          NFTs
                                                                    </p>
                                                                    <br />
                                                                </div>
